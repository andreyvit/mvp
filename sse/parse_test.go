...
func parseStream(input string) string {
	var events []string
	ParseStream(io.NopCloser(iotest.OneByteReader(strings.NewReader(input))), 1024, func(id, event string, data []byte) error {
